...
<div class="image-3d">
  <img src="https://www.nasa.gov/sites/default/files/thumbnails/image/as11-44-6550.jpg" alt="Moon from space" />
</div>
...
- **Remote Sensing & GIS** (Time-Series, Tree Species Classification)
- **ML for Forestry** (Machine learning, forest inventory)

## Featured Project: National Forest Inventory in Turkey (2025)

- **[National Forest Inventory Dashboard (RShiny)](http://tuoe.me/)** – built with R Shiny, hosted on Microsoft Azure. Visualizes multi-year national inventory datasets with interactive tools and dynamic analytics.
...
**PhD Researcher & Teaching Assistant** – Edmonton, Canada (Jan 2023 – Present)
...
**Remote Sensing & Forest Informatics Specialist** – Ankara, Turkey (May 2018 – Apr 2025)
...
R, Python, Git, QGIS, Docker, MATLAB, Microsoft Azure
